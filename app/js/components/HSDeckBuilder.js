    ...
    return (
      <div>
        <ResponsiveReactGridLayout layouts={this.state.layouts} onLayoutChange={this.onLayoutChange}
          ...
          <div key="a" data-grid={{x: 0, y: 0, w: 3, h: 12, static: true}} className="hearthstone_scroll">
            ...
            <div className="row dropFade" style={{display: this.state.showDeckBuilder ? 'block' : 'none'}}>
              ...
              <ResponsiveReactGridLayout layouts={this.state.layouts} onLayoutChange={this.onLayoutChange}
                  onBreakpointChange={this.onBreakpointChange} {...this.props}>
                  <div key="b" data-grid={{x: 0, y: 0, w: 1, h: 11, static: true}} className="hearthstone_scroll">
                  ...
                  <div key="c" data-grid={{x: 1, y: 0, w: 1, h: 11, static: true}} className="hearthstone_scroll">
                    <h4>Neutral Cards</h4>
                  ...
                  <div key="d" data-grid={{x: 2, y: 0, w: 1, h: 11, static: true}} className="hearthstone_scroll">
                    <h4>Deck</h4>
                    <ul id="deck_list">
                      {this.state.myDeck}
                    </ul>
